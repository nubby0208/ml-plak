    ...
    <div v-if="!flgCargandoPresupuesto">
      <div class="col-12 mb-3 p-100 text-left">
        <button
          ...
          :disabled="presupuesto.cliente.token_project == null || presupuesto.estado == 0"
          @click="reiniciarPresupuesto()"
        >Reiniciar presupuesto</button>
        <button
          class="btn btn-sm btn-secondary mr-3"
          :disabled="(presupuesto.cliente.token_project == null) || presupuesto.estado == 0"
          @click="generarPedidoPresupuesto(true)"
        >Generar nuevo pedido de presupuesto</button>
        <button
          class="btn btn-sm btn-secondary mr-3"
          @click="generarPedidoPresupuesto(false)"
          :disabled="presupuesto.id == null || presupuesto.estado == 0"
        >Actualizar presupuesto actual</button>
        <button
        ...
        <button
          ...
          v-if="presupuesto.estado == 0"
          @click="reabrirPresupuesto()"
        >Reabrir presupuesto</button>
      </div>
      <div class="col-12 flex">
            ...
            >
              ...
              <tbody>
                <tr>
                  ...
                  <td class="total">
                    <span style="font-size:16px;">${{round(getTotal(false))}}</span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="total">
                    <span style="font-size:16px;">${{round(getTotal(true))}}</span>
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <div class="ml-5" v-if="presupuestosGuardados.length > 0">
          ...
          <b-badge
            class="mb-3"
            variant="primary"
            v-for="(pg, index) in presupuestosGuardados"
            :key="pg.id"
            @click="cargarPresupuesto(pg, (index + 1))"
            style="display:block; cursor: pointer"
          >{{'Presupuesto número ' +(index + 1) +": " + pg.usuario + " / " + pg.fecha}}</b-badge>
        </div>
        ...
        <div class="container">
          <div class="row mt-4">
            <div class="col-3 flex p-0">
              <p>Canal de comunicación del cliente:</p>
            </div>
            <div class="col-9">
              <div class="row text-left">
                <div class="col-2">
                  <div class="form-check">
                    <input
                      ...
                      v-model="presupuesto.canalComunicacion.fb"
                      type="checkbox"
                      value
                      id="fb"
                    />
                ...
                <div class="col-2">
                  <div class="form-check">
                    <input
                      class="form-check-input"
                      v-model="presupuesto.canalComunicacion.ig"
                      type="checkbox"
                      value
                      id="ig"
                    />
                ...
                <div class="col-2">
                  <div class="form-check">
                    <input
                      class="form-check-input"
                      v-model="presupuesto.canalComunicacion.wp"
                      type="checkbox"
                      value
                      id="wp"
                    />
                ...
                <div class="col-2">
                  <div class="form-check">
                    <input
                      class="form-check-input"
                      v-model="presupuesto.canalComunicacion.mail"
                      type="checkbox"
                      value
                      id="mail"
                    />
                ...
                <div class="col-2">
                  <div class="form-check">
                    <input
                      class="form-check-input"
                      v-model="presupuesto.canalComunicacion.local"
                      type="checkbox"
                      value
                      id="local"
                    />
            ...
            <div class="col-12 p-0">
              <div class="form-group row">
                <label
                  for="staticEmail"
                  class="col-3 flex align-items-center"
                >Nombre del cliente en red social:</label>
                <div class="col-6">
                  <input
                    type="text"
                    class="form-control"
                    id="staticEmail"
                    v-model="presupuesto.nombreRedSocialCliente"
                    placeholder="Agregue aquí el nombre del cliente en la red social "
                  />
                </div>
              </div>
            </div>
      ...
      <div class="content shadow">
        <div class="flex justify-center bg-lightblue align-items-center p-2">
          ...
          <div class="col-6 text-white flex justify-content-end">
            <a class="mr-3 pointer" @click="guardarPreset()">Guardar</a>
            <a class="pointer" @click="openModalPreset()">Cargar preset</a>
          </div>
        </div>
        <div class="container">
      ...
      <div class="content shadow">
        <div class="justify-center bg-lightblue align-items-center p-2">
          <b class="text-white">Seguimiento post presupuesto</b>
        </div>
        ...
        <div class="container">
          <div class="row mt-4">
            <div class="col-12 p-0">
              <div class="form-group row text-left">
                <label for="staticEmail" class="col-sm-5 col-form-label">
                  <b>Texto enviado al cliente:</b>
                </label>
                <div class="col-sm-7">
                  <textarea
                    type="text"
                    class="form-control"
                    placeholder="Texto enviado al cliente"
                    v-model="presupuesto.postPresupuesto.postTexto"
                  />
                </div>
              </div>
              <div class="form-group row text-left">
                <label for="staticEmail" class="col-sm-5 col-form-label">
                  <b>El cliente respondió:</b>
                </label>
                <div class="col-sm-7">
                  <textarea
                    type="text"
                    class="form-control"
                    placeholder="El cliente respondió"
                    v-model="presupuesto.postPresupuesto.postRespondio"
                  />
                </div>
              </div>
              <div class="form-group row text-left">
                <label for="staticEmail" class="col-sm-5 col-form-label">
                  <b>Comentario interno de presupuesto:</b>
                </label>
                <div class="col-sm-7">
                  <textarea
                    type="text"
                    class="form-control"
                    placeholder="Comentario interno de presupuesto"
                    v-model="presupuesto.postPresupuesto.postInterno"
                  />
                </div>
              </div>
            </div>
      ...
      <div class="content shadow">
        <div class="justify-center bg-lightblue align-items-center p-2">
          <b class="text-white">Seguimiento en caso de que se retome el interés del cliente</b>
        </div>
              ...
              <div class="form-group row text-left">
                ...
                <div class="col-sm-7">
                  <textarea
                    ...
                    class="form-control"
                    placeholder="Texto enviado al cliente"
                    v-model="presupuesto.retomoPresupuesto.retomaTexto"
                  />
                </div>
              </div>
              <div class="form-group row text-left">
                ...
                <div class="col-sm-7">
                  <textarea
                    ...
                    class="form-control"
                    placeholder="El cliente respondió"
                    v-model="presupuesto.retomoPresupuesto.retomaRespondio"
                  />
                </div>
              </div>
              <div class="form-group row text-left">
                ...
                <div class="col-sm-7">
                  <textarea
                    ...
                    class="form-control"
                    placeholder="Comentario interno de presupuesto"
                    v-model="presupuesto.retomoPresupuesto.retomaInterno"
                  />
                </div>
              </div>
            </div>
...
export default {
  ...
  mounted: function () {
    ...
    if (vuex) {
      ...
      this.traerPresupuestoAbierto(false);
  ...
  methods: {
    ...
    exportarPdf() {
      ...
      this.generarPedidoPresupuesto(false, () => {
        let obj = {
    ...
    generarPedidoPresupuesto(nuevo, callback = null) {
      ...
      let results = `{
              ...
              )}, "canalComunicacion": ${JSON.stringify(
        this.presupuesto.canalComunicacion
      )}, "nombreRedSocialCliente": ${JSON.stringify(
        this.presupuesto.nombreRedSocialCliente
      )}, "comentarioResumen": ${JSON.stringify(
        this.presupuesto.comentarioResumen
      )}, "comentarioOpcional": ${JSON.stringify(
        this.presupuesto.comentarioOpcional
      )}, "observaciones": ${JSON.stringify(
        this.presupuesto.observaciones
      )}, "postPresupuesto": ${JSON.stringify(
        this.presupuesto.postPresupuesto
      )}, "retomoPresupuesto": ${JSON.stringify(
        this.presupuesto.retomoPresupuesto
      )}, "lineaClasica": ${JSON.stringify(
        this.presupuesto.lineaClasica
      )}, "lineaPremium": ${JSON.stringify(
        this.presupuesto.lineaPremium
      )}, "color": ${JSON.stringify(
        this.presupuesto.color
      )}, "validezPresupuesto": ${JSON.stringify(
        this.presupuesto.validezPresupuesto
      )},"validezPromo": ${JSON.stringify(
        this.presupuesto.validezPromo
      )}, "detalles": ${JSON.stringify(
        this.presupuesto.detalles
      )},"condicionesPago": ${JSON.stringify(
        this.presupuesto.condicionesPago
      )}, "comentarioInternoPresupuesto": ${JSON.stringify(
        this.presupuesto.comentarioInternoPresupuesto
      )}, "piezas": ${JSON.stringify(this.presupuesto.piezas)},
       "precioFinalClasica": ${this.round(this.getTotal(false))},
       "precioFinalPremium":  ${this.round(this.getTotal(true))},
