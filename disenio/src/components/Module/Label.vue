<template>
<div>
    <div v-if="showDimensions && (!element.childs || (isElementLayerVisible && element.layerId != -1 && element.childs)) && !element.separator" class="fancy-container"><span class="fancy">{{ element.id }}</span></div>
</div>
</template>
