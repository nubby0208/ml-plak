...
<template>
<div>
    <h4 v-if="!this.isCorrediza">Puerta:</h4>
    <h4 v-if="this.isCorrediza">Puerta Corrediza (grupo):</h4>    
    ...
    <table class="table table-bordered">
        <tr v-if="this.selectedElement.separator && !this.doorIsCompleted && this.currentSide === 1" class="door-step-background">
          <td>{{firstStepText}}</td>
          <td>
            <div class="door-option" v-for="option in stepOneIds" @mouseover="setHoveredElement(option)" @click="addDoorElement(option)">{{option}}</div>
          </td>
        </tr>
        <tr v-if="this.selectedElement.separator && !this.doorIsCompleted && this.currentSide === 2" class="door-step-background">
          ...
          <td>
            <div class="door-option" v-for="option in stepTwoIds" @mouseover="setHoveredElement(option)" @click="addDoorElement(option)">{{option}}</div>
          </td>
        </tr>
        <tr v-if="this.selectedElement.separator && !this.doorIsCompleted && this.currentSide === 3" class="door-step-background">
          <td>{{thirdStepText}}</td>
          <td>
            <div class="door-option" v-for="option in stepThreeIds" @mouseover="setHoveredElement(option)" @click="addDoorElement(option)">{{option}}</div>
          </td>
        </tr>
    ...
    <edit-tapacantospuerta v-if="tapacantos"></edit-tapacantospuerta>
