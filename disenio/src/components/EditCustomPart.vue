    ...
    <div>
        ...
        <div class="row">
            <div class="col-9">
                <table>
                    <tr>
                        ...
                        <td><input v-bind:class="{ error: !validName() }" class="form-control form-control-sm" v-model="currentPart.Name"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                        <select  v-model="currentPart.tapacantos.izquierdo" class="form-control form-control-sm">
                        ...
                        <td>
                            <select  v-model="currentPart.tapacantos.derecho" class="form-control form-control-sm">
                                <option v-for="tapacanto in availableTapacantos" :key="tapacanto" :value="tapacanto">{{ tapacanto }}
                                </option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select  v-model="currentPart.tapacantos.superior" class="form-control form-control-sm">
                                <option v-for="tapacanto in availableTapacantos" :key="tapacanto" :value="tapacanto">{{ tapacanto }}
                                </option>
                            </select>
                        </td>
                        ...
                        <td>
                            <select  v-model="currentPart.tapacantos.inferior" class="form-control form-control-sm">
                                <option v-for="tapacanto in availableTapacantos" :key="tapacanto" :value="tapacanto">{{ tapacanto }}
                                </option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td><input type="number" class="form-control form-control-sm" v-model="currentPart.LVeta"></td>
                        <td><label>A Veta:</label></td>
                        <td><input type="number" class="form-control form-control-sm" v-model="currentPart.AVeta"></td>
                    </tr>

                    <tr>
                        <td><label>Material:</label></td>
                        <td> 
                            <select v-model="currentPart.material" class="form-control form-control-sm">
                              <option v-for="material in availableMaterials" :key="material" :value="material">{{ material }}</option>
                            </select>
                        </td>
                        <td><label>Orientacion:</label></td>
                        <td>
                            <select  v-model="currentPart.Orientacion" class="form-control form-control-sm">
                    ...
                    <tr>
                        ...
                        <td><input class="form-control form-control-sm" v-model="currentPart.Espesor"></td>
                        <td><label>X:</label></td>
                        <td><input class="form-control form-control-sm" v-model="currentPart.X"></td>
                    </tr>
                    <tr>
                        <td><label>Y:</label></td>
                        <td><input class="form-control form-control-sm" v-model="currentPart.Y"></td>
                        <td><label>Z:</label></td>
                        <td><input class="form-control form-control-sm" v-model="currentPart.Z"></td>
                    </tr>
                    <tr>
                        <td>
                        </td>
                    ...
                    <tr>
                      ...
                      <td v-if="moduleCount > 1">
                          <select v-model="currentModuleId" class="form-control form-control-sm">
            ...
            <div class="pieces col-3">
                ...
                <div class="pieza" v-for="o in getPartsList()"  v-bind:key="o.name">
...
export default {
  ...
  methods: {
    ...
    load (pieza) {
      ...
      this.currentPart.Name = pieza.name
      this.currentPart.Espesor = pieza.size
